...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Tag', fields ['name', 'owner']
        db.create_unique('usertagging_tag', ['name', 'owner_id'])

        # Adding model 'UserTaggedItem'
        db.create_table('usertagging_usertaggeditem', (
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['usertagging.Tag'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        # Adding unique constraint on 'UserTaggedItem', fields ['tag', 'content_type', 'object_id']
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Tag', fields ['name', 'owner']
        db.delete_unique('usertagging_tag', ['name', 'owner_id'])

        # Deleting model 'UserTaggedItem'
        db.delete_table('usertagging_usertaggeditem')

        # Removing unique constraint on 'UserTaggedItem', fields ['tag', 'content_type', 'object_id']
    ...
    models = {
        ...
        'usertagging.tag': {
            'Meta': {'unique_together': "(('name', 'owner'),)", 'object_name': 'Tag'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'usertagging.usertaggeditem': {
            'Meta': {'unique_together': "(('tag', 'content_type', 'object_id'),)", 'object_name': 'UserTaggedItem'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
