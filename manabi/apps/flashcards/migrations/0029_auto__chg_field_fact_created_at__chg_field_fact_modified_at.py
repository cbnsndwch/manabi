...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fact.created_at'
        db.alter_column(u'flashcards_fact', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Fact.modified_at'
        db.alter_column(u'flashcards_fact', 'modified_at', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Fact.created_at'
        db.alter_column(u'flashcards_fact', 'created_at', self.gf('django.db.models.fields.DateTimeField')())

        # User chose to not deal with backwards NULL issues for 'Fact.modified_at'
        raise RuntimeError("Cannot reverse this migration. 'Fact.modified_at' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Fact.modified_at'
        db.alter_column(u'flashcards_fact', 'modified_at', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'flashcards.card': {
            ...
            'legacy_template': ('django.db.models.fields.related.ForeignKey', [], {'db_index': 'False', 'to': "orm['flashcards.CardTemplate']", 'null': 'True', 'blank': 'True'}),
            ...
            'template': ('django.db.models.fields.SmallIntegerField', [], {})
        },
