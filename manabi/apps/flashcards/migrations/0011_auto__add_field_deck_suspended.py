...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Deck.suspended'
        db.add_column('flashcards_deck', 'suspended', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Deck.suspended'
        db.delete_column('flashcards_deck', 'suspended')
