...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Fact.priority'
        db.delete_column(u'flashcards_fact', 'priority')
    ...
    def backwards(self, orm):
        # Adding field 'Fact.priority'
        db.add_column(u'flashcards_fact', 'priority',
        ...
        # Changing field 'Fact.modified_at'
        db.alter_column(u'flashcards_fact', 'modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
