...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardHistory.question_duration'
        db.add_column('flashcards_cardhistory', 'question_duration', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CardHistory.question_duration'
        db.delete_column('flashcards_cardhistory', 'question_duration')
