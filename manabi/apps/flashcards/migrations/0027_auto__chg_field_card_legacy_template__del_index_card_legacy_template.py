...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Card.legacy_template'
        db.alter_column(u'flashcards_card', 'legacy_template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flashcards.CardTemplate'], null=True))


    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'Card.legacy_template'
        raise RuntimeError("Cannot reverse this migration. 'Card.legacy_template' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Card.legacy_template'
        db.alter_column(u'flashcards_card', 'legacy_template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flashcards.CardTemplate']))
