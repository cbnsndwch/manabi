...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FactType.min_card_space'
        db.delete_column(u'flashcards_facttype', 'min_card_space')


    def backwards(self, orm):
        # Adding field 'FactType.min_card_space'
        db.add_column(u'flashcards_facttype', 'min_card_space',
                      self.gf('django.db.models.fields.FloatField')(default=0.006944444444444444),
                      keep_default=False)
