...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Deck.shared_at'
        db.add_column('flashcards_deck', 'shared_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Deck.synchronized_with'
        db.add_column('flashcards_deck', 'synchronized_with', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subscriber_decks', null=True, to=orm['flashcards.Deck']), keep_default=False)

        # Adding field 'Deck.shared'
        db.add_column('flashcards_deck', 'shared', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Deck.active'
        db.add_column('flashcards_deck', 'active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'FieldType.disabled_in_form'
        db.add_column('flashcards_fieldtype', 'disabled_in_form', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Fact.synchronized_with'
        db.add_column('flashcards_fact', 'synchronized_with', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subscriber_facts', null=True, to=orm['flashcards.Fact']), keep_default=False)

        # Adding field 'Fact.new_fact_ordinal'
        db.add_column('flashcards_fact', 'new_fact_ordinal', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding unique constraint on 'Fact', fields ['synchronized_with', 'deck']
        db.create_unique('flashcards_fact', ['synchronized_with_id', 'deck_id'])

        # Deleting field 'Card.synchronized_with'
        db.delete_column('flashcards_card', 'synchronized_with_id')
    
    
    def backwards(self, orm):
        
        # Deleting field 'Deck.shared_at'
        db.delete_column('flashcards_deck', 'shared_at')

        # Deleting field 'Deck.synchronized_with'
        db.delete_column('flashcards_deck', 'synchronized_with_id')

        # Deleting field 'Deck.shared'
        db.delete_column('flashcards_deck', 'shared')

        # Deleting field 'Deck.active'
        db.delete_column('flashcards_deck', 'active')

        # Deleting field 'FieldType.disabled_in_form'
        db.delete_column('flashcards_fieldtype', 'disabled_in_form')

        # Deleting field 'Fact.synchronized_with'
        db.delete_column('flashcards_fact', 'synchronized_with_id')

        # Deleting field 'Fact.new_fact_ordinal'
        db.delete_column('flashcards_fact', 'new_fact_ordinal')

        # Removing unique constraint on 'Fact', fields ['synchronized_with', 'deck']
        db.delete_unique('flashcards_fact', ['synchronized_with_id', 'deck_id'])

        # Adding field 'Card.synchronized_with'
        db.add_column('flashcards_card', 'synchronized_with', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flashcards.Card'], null=True, blank=True), keep_default=False)
