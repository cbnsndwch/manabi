...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardHistory.ease_factor'
        db.add_column('flashcards_cardhistory', 'ease_factor', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'CardHistory.interval'
        db.add_column('flashcards_cardhistory', 'interval', self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True), keep_default=False)

        # Adding field 'CardHistory.was_new'
        db.add_column('flashcards_cardhistory', 'was_new', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CardHistory.ease_factor'
        db.delete_column('flashcards_cardhistory', 'ease_factor')

        # Deleting field 'CardHistory.interval'
        db.delete_column('flashcards_cardhistory', 'interval')

        # Deleting field 'CardHistory.was_new'
        db.delete_column('flashcards_cardhistory', 'was_new')
