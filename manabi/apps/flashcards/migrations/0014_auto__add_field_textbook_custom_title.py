...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Textbook.custom_title'
        db.add_column('flashcards_textbook', 'custom_title', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Textbook.custom_title'
        db.delete_column('flashcards_textbook', 'custom_title')
