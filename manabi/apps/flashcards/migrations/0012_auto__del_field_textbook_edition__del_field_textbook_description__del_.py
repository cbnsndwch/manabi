...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Textbook.edition'
        db.delete_column('flashcards_textbook', 'edition')

        # Deleting field 'Textbook.description'
        db.delete_column('flashcards_textbook', 'description')

        # Deleting field 'Textbook.cover_picture'
        db.delete_column('flashcards_textbook', 'cover_picture')

        # Deleting field 'Textbook.purchase_url'
        db.delete_column('flashcards_textbook', 'purchase_url')

        # Deleting field 'Textbook.name'
        db.delete_column('flashcards_textbook', 'name')

        # Changing field 'Textbook.isbn'
        db.alter_column('flashcards_textbook', 'isbn', self.gf('django.db.models.fields.CharField')(max_length=13))

        # Adding index on 'Deck', fields ['active']
        db.create_index('flashcards_deck', ['active'])


    def backwards(self, orm):
        
        # Removing index on 'Deck', fields ['active']
        db.delete_index('flashcards_deck', ['active'])

        # Adding field 'Textbook.edition'
        db.add_column('flashcards_textbook', 'edition', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Textbook.description'
        db.add_column('flashcards_textbook', 'description', self.gf('django.db.models.fields.TextField')(default='', max_length=2000, blank=True), keep_default=False)

        # Adding field 'Textbook.cover_picture'
        db.add_column('flashcards_textbook', 'cover_picture', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Textbook.purchase_url'
        db.add_column('flashcards_textbook', 'purchase_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Textbook.name'
        db.add_column('flashcards_textbook', 'name', self.gf('django.db.models.fields.CharField')(default='untitled', max_length=100), keep_default=False)

        # Changing field 'Textbook.isbn'
        db.alter_column('flashcards_textbook', 'isbn', self.gf('django.db.models.fields.CharField')(max_length=20))
