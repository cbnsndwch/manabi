...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Card.deck'
        db.add_column(u'flashcards_card', 'deck',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flashcards.Deck'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Card.deck'
        db.delete_column(u'flashcards_card', 'deck_id')
    ...
    models = {
        ...
        'flashcards.card': {
            ...
            'deck': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['flashcards.Deck']", 'null': 'True'}),
