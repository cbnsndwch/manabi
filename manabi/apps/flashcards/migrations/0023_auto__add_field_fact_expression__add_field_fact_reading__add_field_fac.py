...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'flashcards_card', ['fact_id', 'template_id'])

        # Adding field 'Fact.expression'
        db.add_column(u'flashcards_fact', 'expression',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'Fact.reading'
        db.add_column(u'flashcards_fact', 'reading',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1500, blank=True),
                      keep_default=False)

        # Adding field 'Fact.meaning'
        db.add_column(u'flashcards_fact', 'meaning',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000),
                      keep_default=False)

        # Rename field 'Card.template' to legacy_template
        db.rename_column('flashcards_card', 'template_id', 'legacy_template_id')
        

    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'Card.template'
        raise RuntimeError("Cannot reverse this migration. 'Card.template' and its values cannot be restored.")
    ...
    models = {
        ...
        'flashcards.card': {
            ...
            'legacy_template': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['flashcards.CardTemplate']"}),
