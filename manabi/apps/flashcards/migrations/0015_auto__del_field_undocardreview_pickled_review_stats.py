...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UndoCardReview.pickled_review_stats'
        db.delete_column('flashcards_undocardreview', 'pickled_review_stats')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'UndoCardReview.pickled_review_stats'
        raise RuntimeError("Cannot reverse this migration. 'UndoCardReview.pickled_review_stats' and its values cannot be restored.")
