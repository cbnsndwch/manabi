"""
Custom managers for Django models registered with the usertagging
application.
"""
...
class TagDescriptor(object):
    ...
    def __set__(self, instance, value):
        if hasattr(instance, 'owner'):
            ...
            owner_user = None
        Tag.objects.update_tags(instance, value, owner_user)
    ...
    def __delete__(self, instance):
        if hasattr(instance, 'owner'):
            ...
            owner_user = None
        Tag.objects.update_tags(instance, None, owner_user)
