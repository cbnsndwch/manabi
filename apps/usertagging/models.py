"""
Models and managers for generic usertagging.
"""
...
class TagManager(models.Manager):
    def update_tags(self, obj, tag_names, owner=None):
        """
    ...
    def cloud_for_model(self, model, steps=4, distribution=LOGARITHMIC,
        ...
        be either ``usertagging.utils.LOGARITHMIC`` or
        ``usertagging.utils.LINEAR``.
...
class Tag(models.Model):
    ...
    class Meta:
        unique_together = (('name', 'owner'),) #FIXME does this work when owner==None?
        ordering = ('name',)
        verbose_name = _('tag')
