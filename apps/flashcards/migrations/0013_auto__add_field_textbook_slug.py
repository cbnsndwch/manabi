...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Textbook.slug'
        db.add_column('flashcards_textbook', 'slug', self.gf('django.db.models.fields.SlugField')(default='genki-textbook-sample-slug', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Textbook.slug'
        db.delete_column('flashcards_textbook', 'slug')
