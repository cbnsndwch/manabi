...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Make the display_name equal to the name"
        field_types = orm['flashcards.FieldType'].objects.all()
        for field_type in field_types:
            field_type.display_name = field_type.name
            field_type.name = field_type.id
            field_type.save()
    ...
    def backwards(self, orm):
        ...
        field_types = orm['flashcards.FieldType'].objects.all()
        for field_type in field_types:
            field_type.name = field_type.display_name
            field_type.save()
